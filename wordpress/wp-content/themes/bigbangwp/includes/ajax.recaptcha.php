...
$email_from_2 = get_option(BRANKIC_VAR_PREFIX."email_from_2");



$subject = get_option(BRANKIC_VAR_PREFIX."email_subject");
for($i=1 ; $i <=5 ; $i++)
{
    $captions[] = get_option(BRANKIC_VAR_PREFIX."field_". $i ."_caption");  
}
